...
case_part1_a_test() -> 5 = first([0, 3, 0, 1, -3]).
case_part1_b_test() -> 373543 = first(?PUZZLE).
...
case_part2_a_test() -> 10 = second([0, 3, 0, 1, -3]).
case_part2_b_test_() -> {timeout, 60, fun() -> 27502966 = second(?PUZZLE) end}.